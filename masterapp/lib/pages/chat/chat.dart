            ...
            _TopBarNavy(
              ...
              onGear: () {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(const SnackBar(content: Text("Gear clicked")));
              },
              onBell: () {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _SearchRow(controller: _searchC, onNewMessage: () {}),
                    const SizedBox(height: 12),
...
class _SearchRow extends StatelessWidget {
  ...
  const _SearchRow({required this.controller, required this.onNewMessage});
